  ...
  return (
    <div className="w-screen h-screen bg-black">
      <div className="absolute w-full h-full flex justify-center">
        ...
        <img id="courtPic" className="opacity-10 object-cover" src="https://wallup.net/wp-content/uploads/2019/09/158384-oklahoma-city-thunder-basketball-nba-gp.jpg"></img>
      </div>
    </div>
  );
}
